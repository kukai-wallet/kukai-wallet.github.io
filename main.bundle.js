...
module.exports = "<div id=\"content\">\r\n    <div class=\"center-content\">\r\n        <div class=\"row\">\r\n            <a routerLink=\"/new-wallet/\" class=\"active-link\"><button type=\"button\" class=\"btn btn-primary btn-lg btn-block btn-generate\">Generate wallet</button></a>\r\n        </div>\r\n        <div class=\"row justify-content-between\">\r\n            <a routerLink=\"/broadcast/\"><button type=\"button\" class=\"btn btn-clear btn-second\">Broadcast</button></a>\r\n            <a routerLink=\"/import/\"><button type=\"button\" class=\"btn btn-clear btn-second\">Import</button></a>\r\n        </div>\r\n        <a routerLink=\"/activate/\">Activate ICO-wallet</a>\r\n        <!--\r\n        <div class=\"row justify-content-end\">\r\n            <a routerLink=\"/ico-wallet/\">Retrieve ICO wallet</a>\r\n        </div>\r\n        -->\r\n    </div>\r\n</div>\r\n"
...
var ActivityService = /** @class */ (function () {
    function ActivityService(walletService, http, messageService) {
        ...
        this.http = http;
        this.messageService = messageService;
        this.apiUrl = 'http://api.tzscan.io/';
        ...
        return __awaiter(this, void 0, void 0, function () {
            ...
            return __generator(this, function (_a) {
                if (pkh) {
                    ...
                    console.log('pkh: ' + pkh);
                    this.http.get('http://zeronet-api.tzscan.io/v1/number_operations/' + pkh + '?type=Origination').subscribe(function (data) {
                        if (data[0]) {
    ...
    ImportService.prototype.findAccounts = function (pkh, n) {
        return __awaiter(this, void 0, void 0, function () {
            ...
            return __generator(this, function (_a) {
                ...
                this.http.get('http://zeronet-api.tzscan.io/v1/operations/' + pkh + '?type=Origination&number=' + n + '&p=0').subscribe(function (data) {
                    for (var i = 0; i < n; i++) {
